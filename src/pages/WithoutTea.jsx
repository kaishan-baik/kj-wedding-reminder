    ...
    <div className="flex flex-col items-center justify-center w-full text-center my-4 font-serif">
      <div className="card bg-yellow-50 w-4/5 p-4 ">
        ...
        <div className="flex flex-col p-5 bg-yellow-100 text-slate-800 sm:w-4/5 sm:mx-auto sm:px-24">
          <div className="py-2">
            <h3 className="celebrate capitalize my-2 text-2xl font-bold text-red-500 sm:text-3xl flex items-center justify-center">
              <BiSolidParty />
              let's celebrate!
            </h3>
            <div>
          ...
          <div lang="zh-CN" className="py-2">
            <h3 className="celebrate capitalize my-2 text-2xl font-bold text-red-500 flex  justify-center">
              <BiSolidParty />
              欢迎 !
            </h3>
            <div>
